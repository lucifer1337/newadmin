...
function Moving(ply, move)
	if LocalPlayer():GetNetworkedInt("Frozen") == 1 then
		return true
	end
end
...
function FillPlayerList()
	...
	for k, v in pairs(ListPlayers:GetItems()) do
		...
		CheckBoxBlind:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Blinded"))
		CheckBoxGod:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("GodMode"))
		CheckBoxIgnite:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Ignited"))
		CheckBoxCloak:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Cloaked"))
		CheckBoxMute:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Muted"))
		CheckBoxFrozen:SetValue(GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Frozen"))
		break
	end
end
...
function CreatePlayerTab()
	...
	CheckBoxBlind.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Blinded") then		
	...
	CheckBoxGod.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("GodMode") then		
	...
	CheckBoxIgnite.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Ignited") then		
	...
	CheckBoxCloak.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Cloaked") then		
	...
	CheckBoxMute.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Muted") then		
	...
	CheckBoxFrozen.OnChange = function ()
		if ListPlayers:GetSelectedItems()[1] ~= nil then
			...
			if checkval ~= GetPlayerbyNick(ListPlayers:GetSelectedItems()[1]:GetValue()):GetNetworkedInt("Frozen") then		
...
function CreateServerTab()
	...
	Hostname:SetValue( GetGlobalString("ServerName") )
