...
function PANEL:OnMousePressed(  )
	...
	if self.CheckBoolean == nil or !self.Checkbox:GetChecked() then
		RunConsoleCommand( "NA_CallCommand", "!" .. string.Replace( self.OnCommand, "[PLAYER]", tostring(GetSelectedPlayer():UserID()) ) )
	else
		RunConsoleCommand( "NA_CallCommand", "!" .. string.Replace( self.OffCommand, "[PLAYER]", tostring(GetSelectedPlayer():UserID()) ) )
	end
